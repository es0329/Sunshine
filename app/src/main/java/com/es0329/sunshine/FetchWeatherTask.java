...
//                mContext.getString(R.string.pref_units_option0_value));
//
//        if (unitType.equals(mContext.getString(R.string.pref_units_option1_value))) {
//            high = (high * 1.8) + 32;
//            low = (low * 1.8) + 32;
//        } else if (!unitType.equals(mContext.getString(R.string.pref_units_option0_value))) {
