...
//    }
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent sunshineIntent = new Intent(context, SunshineService.class);
            sunshineIntent.putExtra(SunshineService.KEY_LOCATION_QUERY, Utility.getPreferredLocation(context));
            context.startService(sunshineIntent);
        }
    }
}
