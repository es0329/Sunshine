package com.es0329.sunshine.sync;
...
import com.es0329.sunshine.MainActivity;
import com.es0329.sunshine.R;
import com.es0329.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String query = Utility.getPreferredLocation(getContext());
...
//                Log.i(LOG_TAG, "" + zonedDateTime);
            ...
            Log.d(LOG_TAG, "#getWeatherDataFromJson: inserted " + rowsInserted + " rows.");
        } catch (JSONException e) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToFirst()) {
            ...
            Uri newRow = getContext().getContentResolver()
